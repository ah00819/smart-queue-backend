...
# TWILIO_PHONE_NUMBER = env("TWILIO_PHONE_NUMBER") # The purchased Twilio phone number
TWILIO_WHATSAPP_NUMBER = env("TWILIO_WHATSAPP_NUMBER") # The specific Sandbox number given to you
